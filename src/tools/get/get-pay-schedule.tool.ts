...
const getPayScheduleTool = CreateTool(
  ...
  async (args) => {
    ...
    const paySchedulesList =
      paySchedules.data as GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse;

    const paySchedulesText = paySchedulesList.payScheduleObject
      ? formatPaySchedule(paySchedulesList.payScheduleObject)
